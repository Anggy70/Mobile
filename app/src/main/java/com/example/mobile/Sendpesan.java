...
public class Sendpesan extends AppCompatActivity {
    private final static String TAG="AppCallLink";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sendpesan);
        Log.i(TAG, "Pada Event onCreate");
    }

    public void onClickCallsEvens (View view) {
        Intent intent = new Intent(Intent.ACTION_SEND, Uri.parse("tel: +62081328682225"));
